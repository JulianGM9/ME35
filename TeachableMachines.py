#Code to send start and stop commands read by the teachable machines model to the picos
...
#these two functions retrieve data from the teachable machines model
...
#Main loop, sends relevant command based on the ai models predictions
while True:
